...
const productsReducer = (state = initialState, action)=> {
    ...
    switch(action.type){
        ...
        case UPDATE_PRODUCT:
             const productIndex  = state.userProducts.findIndex((prod, i)=> {
                 if(prod===action.pid){
                     return i;
                 }
             });
            ...
            const availableProductIndex = state.availableProducts.findIndex((prod, i)=> {
                if(prod===action.pid){
                    return i;
                }
            });
            const updatedAvaiableProducts = [
            ...
            return {
                ...state,
                availableProducts : updatedAvaiableProducts,
